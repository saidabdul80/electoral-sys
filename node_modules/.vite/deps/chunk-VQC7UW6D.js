...
function ma(e, t) {
  return e < 65 ? 36 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && da.test(String.fromCharCode(e)) : false !== t && fa(e, aa)));
}
function ga(e, t) {
  return e < 48 ? 36 === e : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && pa.test(String.fromCharCode(e)) : false !== t && (fa(e, aa) || fa(e, ra)))));
}
function xa(e, t) {
  return new ya(e, { beforeExpr: true, binop: t });
}
function Sa(e, t) {
  return void 0 === t && (t = {}), t.keyword = e, va[e] = new ya(e, t);
}
function ka(e) {
...
function Ua(e) {
  ...
  if ("latest" === t.ecmaVersion ? t.ecmaVersion = 1e8 : null == t.ecmaVersion ? (!ja && "object" == typeof console && console.warn && (ja = true, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), null == t.allowReserved && (t.allowReserved = t.ecmaVersion < 5), Ra(t.onToken)) {
    var s = t.onToken;
  ...
  return Ra(t.onComment) && (t.onComment = function(e2, t2) {
    return function(i2, s2, n2, r2, a2, o2) {
      ...
      e2.locations && (l2.loc = new Ba(this, a2, o2)), e2.ranges && (l2.range = [n2, r2]), t2.push(l2);
    };
  }(t, t.onComment)), t;
}
function Ga(e, t) {
...
function ho(e) {
  return "MemberExpression" === e.type && "PrivateIdentifier" === e.property.type || "ChainExpression" === e.type && ho(e.expression);
}
function yo(e, t, i, s) {
...
async function Ko(e, t, i, s, n2, r2, a2, o2) {
  ...
  return null == l2 && Wo("path.resolve"), l2;
}
function Xo(e, t, { hook: i, id: s } = {}) {
...
function il(e, { fileName: t, name: i }, s, n2) {
  var r2;
  if (null !== t)
...
function ol(e, t, i, s, n2, r2) {
  ...
  if ("string" != typeof e.cacheKey && (e.name.startsWith("at position ") || e.name.startsWith("at output position ") || r2.has(e.name) ? o2 = false : r2.add(e.name)), t)
    if (o2) {
      ...
      l2 = e.name, a2 = { delete: () => Zo(l2), get: () => Zo(l2), has: () => Zo(l2), set: () => Zo(l2) };
  else
    a2 = Qo;
  var l2, h2;
  ...
  }, cache: a2, emitAsset: al((e2, t2) => n2.emitFile({ name: e2, source: t2, type: "asset" }), "emitAsset", "emitFile", e.name, true, s), emitChunk: al((e2, t2) => n2.emitFile({ id: e2, name: t2 && t2.name, type: "chunk" }), "emitChunk", "emitFile", e.name, true, s), emitFile: n2.emitFile.bind(n2), error: (t2) => Xo(t2, e.name), getAssetFileName: al(n2.getFileName, "getAssetFileName", "getFileName", e.name, true, s), getChunkFileName: al(n2.getFileName, "getChunkFileName", "getFileName", e.name, true, s), getFileName: n2.getFileName, getModuleIds: () => i.modulesById.keys(), getModuleInfo: i.getModuleInfo, getWatchFiles: () => Object.keys(i.watchFiles), isExternal: al((e2, t2, i2 = false) => s.external(e2, t2, i2), "isExternal", "resolve", e.name, true, s), load: (e2) => i.moduleLoader.preloadModule(e2), meta: { rollupVersion: "2.78.1", watchMode: i.watchMode }, get moduleIds() {
  ...
  }, parse: i.contextParse.bind(i), resolve: (t2, s2, { custom: n3, isEntry: r3, skipSelf: a3 } = ie) => i.moduleLoader.resolveId(t2, s2, n3, r3, a3 ? [{ importer: s2, plugin: e, source: t2 }] : null), resolveId: al((e2, t2) => i.moduleLoader.resolveId(e2, t2, ie, void 0).then((e3) => e3 && e3.id), "resolveId", "resolve", e.name, true, s), setAssetSource: n2.setAssetSource, warn(t2) {
    "string" == typeof t2 && (t2 = { message: t2 }), t2.code && (t2.pluginCode = t2.code), t2.code = "PLUGIN_WARNING", t2.plugin = e.name, s.onwarn(t2);
  } };
}
function cl(e, t, i = ul) {
  const s = [], n2 = [], r2 = [];
  for (const a2 of t) {
    const t2 = a2[e];
    if (t2) {
...
function Fl(e) {
  const t = Bl.exec(e), i = t ? t[0] : "";
  return i + e.substr(i.length).replace(Vl, "_");
}
function Zl(e, t) {
  const i = e.exports;
  if (null == i)
...
function oh(e) {
  return async function(e2, t) {
    const { options: i, unsetOptions: s } = await async function(e3, t2) {
      ...
      const i2 = cl("options", gl(e3.plugins)), { options: s2, unsetOptions: n3 } = function(e4) {
        var t3, i3, s3;
        const n4 = /* @__PURE__ */ new Set(), r3 = null !== (t3 = e4.context) && void 0 !== t3 ? t3 : "undefined", a3 = Il(e4), o2 = e4.strictDeprecations || false, l2 = Tl(e4, a3, o2), h2 = { acorn: Pl(e4), acornInjectPlugins: kl(e4), cache: wl(e4), context: r3, experimentalCacheExpiry: null !== (i3 = e4.experimentalCacheExpiry) && void 0 !== i3 ? i3 : 10, external: Cl(e4.external), inlineDynamicImports: _l(e4, a3, o2), input: Nl(e4), makeAbsoluteExternalsRelative: null === (s3 = e4.makeAbsoluteExternalsRelative) || void 0 === s3 || s3, manualChunks: $l(e4, a3, o2), maxParallelFileOps: l2, maxParallelFileReads: l2, moduleContext: Ol(e4, r3), onwarn: a3, perf: e4.perf || false, plugins: gl(e4.plugins), preserveEntrySignatures: Rl(e4, n4), preserveModules: Ml(e4, a3, o2), preserveSymlinks: e4.preserveSymlinks || false, shimMissingExports: e4.shimMissingExports || false, strictDeprecations: o2, treeshake: Dl(e4, a3, o2) };
        return El(e4, [...Object.keys(h2), "watch"], "input options", h2.onwarn, /^(output)$/), { options: h2, unsetOptions: n4 };
      }(await i2.reduce(function(e4) {
        return async (t3, i3) => {
          const s3 = "handler" in i3.options ? i3.options.handler : i3.options;
          return await s3.call({ meta: { rollupVersion: "2.78.1", watchMode: e4 } }, await t3) || t3;
        };
      }(t2), Promise.resolve(e3)));
      return lh(s2.plugins, "at position "), { options: s2, unsetOptions: n3 };
    }(e2, null !== t);
    !function(e3) {
      e3.perf ? (Xs = /* @__PURE__ */ new Map(), en = Qs, tn = Zs, e3.plugins = e3.plugins.map(nn)) : (en = Ks, tn = Ks);
    }(i);
    const n2 = new ml(i, t), r2 = false !== e2.cache;
    delete i.cache, delete e2.cache, en("BUILD", 1), await yl(n2.pluginDriver, async () => {
      try {
    ...
    }, closed: false, generate: async (e3) => a2.closed ? pe(Ie()) : hh(false, i, s, e3, n2), watchFiles: Object.keys(n2.watchFiles), write: async (e3) => a2.closed ? pe(Ie()) : hh(true, i, s, e3, n2) };
...
function hh(e, t, i, s, n2) {
  const { options: r2, outputPluginDriver: a2, unsetOptions: o2 } = function(e2, t2, i2, s2) {
    if (!e2)
      throw new Error("You must supply an options object");
    const n3 = gl(e2.plugins);
    lh(n3, "at output position ");
    const r3 = t2.createOutputPluginDriver(n3);
    return { ...ch(i2, s2, e2, r3), outputPluginDriver: r3 };
  }(s, n2.pluginDriver, t, i);
  return yl(0, async () => {
    const i2 = new ia(r2, o2, t, a2, n2), s2 = await i2.generate(e);
    if (e) {
      if (!r2.dir && !r2.file)
      ...
      await Promise.all(Object.values(s2).map((e2) => n2.fileOperationQueue.run(() => async function(e3, t2) {
        ...
        let s3, n3;
        if (await qo.mkdir(N(i3), { recursive: true }), "asset" === e3.type)
          n3 = e3.source;
          ...
          if ("inline" === t2.sourcemap)
            ...
            r3 = n4 ? new URL(a3, n4).toString() : a3, s3 = qo.writeFile(`${i3}.map`, e3.map.toString());
          }
          "hidden" !== t2.sourcemap && (n3 += `//# sourceMappingURL=${r3}
`);
        }
        return Promise.all([qo.writeFile(i3, n3), s3]);
...
function ch(e, t, i, s) {
  return function(e2, t2, i2) {
    ...
    const c2 = new Set(i2), u2 = e2.compact || false, d2 = jl(e2), p2 = Ul(e2, t2), f2 = Gl(e2, p2, t2), m2 = zl(e2, f2, t2), g2 = Hl(e2, t2), y2 = Jl(e2, g2), x2 = { amd: ql(e2), assetFileNames: null !== (s2 = e2.assetFileNames) && void 0 !== s2 ? s2 : "assets/[name]-[hash][extname]", banner: Kl(e2, "banner"), chunkFileNames: null !== (n2 = e2.chunkFileNames) && void 0 !== n2 ? n2 : "[name]-[hash].js", compact: u2, dir: Xl(e2, m2), dynamicImportFunction: Yl(e2, t2), entryFileNames: Ql(e2, c2), esModule: null === (r2 = e2.esModule) || void 0 === r2 || r2, exports: Zl(e2, c2), extend: e2.extend || false, externalLiveBindings: null === (a2 = e2.externalLiveBindings) || void 0 === a2 || a2, file: m2, footer: Kl(e2, "footer"), format: d2, freeze: null === (o2 = e2.freeze) || void 0 === o2 || o2, generatedCode: y2, globals: e2.globals || {}, hoistTransitiveImports: null === (l2 = e2.hoistTransitiveImports) || void 0 === l2 || l2, indent: eh(e2, u2), inlineDynamicImports: p2, interop: ih(e2, t2), intro: Kl(e2, "intro"), manualChunks: sh(e2, p2, f2, t2), minifyInternalExports: nh(e2, d2, u2), name: e2.name, namespaceToStringTag: rh(e2, y2, t2), noConflict: e2.noConflict || false, outro: Kl(e2, "outro"), paths: e2.paths || {}, plugins: gl(e2.plugins), preferConst: g2, preserveModules: f2, preserveModulesRoot: Wl(e2), sanitizeFileName: "function" == typeof e2.sanitizeFileName ? e2.sanitizeFileName : false === e2.sanitizeFileName ? (e3) => e3 : Fl, sourcemap: e2.sourcemap || false, sourcemapBaseUrl: ah(e2), sourcemapExcludeSources: e2.sourcemapExcludeSources || false, sourcemapFile: e2.sourcemapFile, sourcemapPathTransform: e2.sourcemapPathTransform, strict: null === (h2 = e2.strict) || void 0 === h2 || h2, systemNullSetters: e2.systemNullSetters || false, validate: e2.validate || false };
    return El(e2, Object.keys(x2), "output options", t2.onwarn), { options: x2, unsetOptions: c2 };
...
function dh(e) {
  return "asset" === e.type ? uh.ASSET : e.isEntry ? uh.ENTRY_CHUNK : uh.SECONDARY_CHUNK;
}
function ph(e) {
  return e;
}
var e, t, i, s, a, o, l, h, d, m, g, y, x, E, b, v, S, A, I, P, M, D, L, V, B, F, z, j, U, G, H, W, q, K, X, Y, Q, Z, J, ee, te, ie, se, ne, ue, me, we, Ce, _e, $e, Te, Oe, Le, Ve, Be, Fe, ze, je, Ue, Ge, He, We, qe, Ke, Xe, et, tt, it, nt, rt, lt, ct, ut, dt, pt, ft, mt, gt, yt, xt, Et, bt, vt, St, At, It, Pt, kt, wt, Ct, _t, Nt, $t, Tt, Ot, Rt, Mt, Dt, Bt, Ft, zt, jt, Gt, Ht, Wt, qt, Kt, Xt, Yt, Qt, Zt, Jt, ei, ii, si, ni, li, ci, gi, yi, xi, Ei, bi, vi, Pi, ki, wi, Ci, _i, Ni, Ti, Mi, Li, Vi, Bi, Fi, zi, ji, Ui, Gi, Hi, Wi, qi, Ki, Xi, Yi, Qi, Zi, Ji, es, ts, is, ss, ns, rs, as, os, ls, hs, cs, us, ds, ps, fs, ms, gs, ys, bs, vs, Ss, As, Is, Ps, ks, ws, Cs, _s, Ns, $s, Ts, Os, Rs, Ms, Ds, Ls, Bs, Fs, zs, js, Us, Gs, Ws, qs, Ks, Xs, en, tn, sn, an, ln, cn, yn, bn, Sn, Pn, kn, wn, Cn, Nn, $n, On, Rn, Mn, Vn, Bn, zn, jn, Un, Kn, Xn, Yn, Zn, Jn, sr, nr, rr, ar, or, lr, hr, cr, ur, dr, pr, fr, mr, gr, yr, Er, br, vr, Sr, kr, wr, Cr, Dr, Vr, Fr, jr, Wr, Kr, Xr, Zr, ea, ta, ia, ra, aa, oa, la, ha, ca, ua, da, pa, ya, Ea, ba, va, Aa, Ia, Pa, Ca, _a, Na, $a, Ta, Oa, Ra, La, Va, Ba, za, ja, Ha, Wa, qa, Ka, Xa, Ya, Qa, Za, Ja, eo, to, no, ro, ao, oo, lo, co, uo, po, fo, mo, go, xo, Eo, bo, vo, So, Ao, Io, Po, ko, wo, Co, No, $o, To, Oo, jo, Uo, Ho, Wo, qo, Yo, Qo, el, rl, ll, hl, fl, ml, xl, bl, vl, Sl, Al, Il, Pl, kl, wl, Cl, _l, Nl, $l, Tl, Ol, Rl, Ml, Dl, Ll, Vl, Bl, zl, jl, Ul, Gl, Hl, Wl, ql, Kl, Xl, Yl, Ql, Jl, eh, th, ih, sh, nh, rh, ah, uh;
var init_rollup_browser = __esm({
  "node_modules/rollup/dist/es/rollup.browser.js"() {
    for (e = "2.78.1", t = {}, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0; s < i.length; s++)
      t[i.charCodeAt(s)] = s;
    a = class {
      constructor(e) {
    ...
    Z = [];
    J = { args: Z, thisArg: null, type: 2, withNew: false };
    ee = class extends K {
      constructor(e) {
    ...
    He = { value: { hasEffectsWhenCalled({ args: e }, t) {
      ...
      } }) && i.hasEffectsOnInteractionAtPath(V, J, t);
    }, returns: Ue } };
        ...
        if (2 === r2) {
          ...
          if (this.description.callsArgs) {
            for (const e2 of this.description.callsArgs)
              if (null === (n2 = t.args[e2]) || void 0 === n2 ? void 0 : n2.hasEffectsOnInteractionAtPath(V, J, i))
                return true;
          }
        }
        return false;
    ...
    Zt = { __proto__: null, [Gt]: Ht, from: Kt, of: Kt, prototype: qt };
    Jt = { __proto__: null, [Gt]: Ht, supportedLocalesOf: Qt };
    ...
    bi = class extends ut {
      ...
      hasEffectsOnInteractionAtPath(e, t, i) {
        ...
        if (this.async) {
          ...
          if (t2.hasEffectsOnInteractionAtPath(["then"], J, i) || e2 && ("always" === e2 || t2.hasEffectsOnInteractionAtPath(["then"], Y, i)))
            return true;
        }
    ...
    Fi = class extends ut {
      ...
      hasEffectsOnInteractionAtPath(e, t, i) {
        return "get" === this.kind && 0 === t.type && 0 === e.length ? this.value.hasEffectsOnInteractionAtPath(V, { args: Z, thisArg: t.thisArg, type: 2, withNew: false }, i) : "set" === this.kind && 1 === t.type ? this.value.hasEffectsOnInteractionAtPath(V, { args: t.args, thisArg: t.thisArg, type: 2, withNew: false }, i) : this.getAccessedValue().hasEffectsOnInteractionAtPath(e, t, i);
      }
      applyDeoptimizations() {
      }
      getAccessedValue() {
        return null === this.accessedValue ? "get" === this.kind ? (this.accessedValue = X, this.accessedValue = this.value.getReturnExpressionWhenCalledAtPath(V, J, G, this)) : this.accessedValue = this.value : this.accessedValue;
      }
    };
    zi = class extends Fi {
      applyDeoptimizations() {
    ...
    On = { amd: function(e, { accessedGlobals: t, dependencies: i, exports: s, hasExports: n2, id: r2, indent: a2, intro: o2, isEntryFacade: l2, isModuleFacade: h2, namedExportsMode: c2, outro: u2, snippets: d2, warn: p2 }, { amd: f2, esModule: m2, externalLiveBindings: g2, freeze: y2, interop: x2, namespaceToStringTag: E2, strict: b2 }) {
      vn(p2, i);
      const v2 = i.map((e2) => `'${En(e2.id)}'`), S2 = i.map((e2) => e2.name), { n: A2, getNonArrowFunctionIntro: I2, _: P2 } = d2;
      ...
      let J2 = gn(l2 && n2, f2, b2, c2);
      return J2 && (J2 = _2 + _2 + J2), e.append(`${Z2}${J2}${h2}`), e.trim().indent(a2).append(Q2).prepend(Y2);
    } };
    Rn = class {
      constructor(e, t) {
    ...
    Vr = class {
      ...
      static generateFacade(e, t, i, s, n2, r2, a2, o2, l2, h2) {
        const c2 = new Vr([], e, t, i, s, n2, r2, a2, o2, null);
      ...
      generateId(e, t, i, s) {
        ...
        return Mr(Rr("function" == typeof n2 ? n2(this.getChunkInfo()) : n2, r2, { format: () => t.format, hash: () => s ? this.computeContentHashWithDependencies(e, t, i) : "[hash]", name: () => this.getChunkName() }), i);
      }
      generateIdPreserveModules(e, t, i, s) {
        ...
        if (k(r2)) {
          ...
          const e2 = $(r2);
          a2 = `_virtual/${Rr(l2, "output.entryFileNames", { assetExtname: () => Dr.includes(e2) ? "" : e2, ext: () => e2.substring(1), extname: () => e2, format: () => t.format, name: () => le(r2) })}`;
        }
        return Mr(C(a2), i);
      }
      getChunkInfo() {
...
Either change the import in ${he(a2)} to point directly to the exporting module or do not use "preserveModules" to ensure these modules end up in the same chunk.`, reexporter: r2 })), t = l2;
      ...
      getChunkDependencyDeclarations(e, t) {
        ...
        for (const t2 of this.dependencies) {
          ...
          n2.set(t2, { defaultVariableName: t2.defaultVariableName, globalName: t2 instanceof $e && ("umd" === e.format || "iife" === e.format) && Lr(t2, e.globals, null !== (r2 || a2), this.inputOptions.onwarn), id: void 0, imports: r2, isChunk: t2 instanceof Vr, name: t2.variableName, namedExportsMode: o2, namespaceVariableName: t2.namespaceVariableName, reexports: a2 });
        }
        return n2;
      }
    ...
    Wr = class {
      constructor(e, t, i) {
        this.graph = e, this.options = t, this.bundle = null, this.facadeChunkByModule = null, this.outputOptions = null, this.assertAssetsFinalized = () => {
          ...
          return t2 ? "chunk" === t2.type ? Hr(t2, this.facadeChunkByModule) : Gr(t2, e2) : pe((i2 = e2, { code: me.FILE_NOT_FOUND, message: `Plugin error - Unable to get file name for unknown file "${i2}".` }));
          var i2;
          ...
          for (const [e3, t3] of this.filesByReferenceId)
            "asset" === t3.type && void 0 !== t3.source && this.finalizeAsset(t3, t3.source, e3, this.bundle);
      ...
      emitAsset(e) {
        const t = void 0 !== e.source ? Ur(e.source, e, null) : void 0, i = { fileName: e.fileName, name: e.name, source: t, type: "asset" }, s = this.assignReferenceId(i, e.fileName || e.name || e.type);
        return this.bundle && (e.fileName && zr(e.fileName, this.bundle, this.options.onwarn), void 0 !== t && this.finalizeAsset(i, t, s, this.bundle)), s;
      }
      emitChunk(e) {
      ...
      finalizeAsset(e, t, i, s) {
        const n2 = e.fileName || function(e2, t2) {
          for (const [i2, s2] of Object.entries(e2))
            if ("asset" === s2.type && qr(t2, s2.source))
              return i2;
          return null;
        }(s, t) || function(e2, t2, i2, s2) {
          const n3 = i2.sanitizeFileName(e2 || "asset");
          return Mr(Rr("function" == typeof i2.assetFileNames ? i2.assetFileNames({ name: e2, source: t2, type: "asset" }) : i2.assetFileNames, "output.assetFileNames", { ext: () => $(n3).substring(1), extname: () => $(n3), hash: () => vr().update(n3).update(":").update(t2).digest("hex").substring(0, 8), name: () => n3.substring(0, n3.length - $(n3).length) }), s2);
...
${t}` : e;
    Zr = (e, t) => e.execIndex > t.execIndex ? 1 : -1;
    ea = (e, t) => t ? `(${e})` : e;
    ta = /^(?!\d)[\w$]+$/;
    ia = class {
      constructor(e, t, i, s, n2) {
...
${r2}`), i2.length && (i2 += "\n"), s2.length && (s2 = "\n" + s2), { banner: i2, footer: s2, intro: n3, outro: r2 };
	...
	Error Message: ${e4.message}` });
            ...
            } : h2, u2 = (e4, { functionReturn: i3, lineBreakIndent: s3, name: n4 }) => [`${c2(e4, { isAsync: false, name: n4 })}${t2 ? s3 ? `${a2}${s3.base}${s3.t}` : "" : `{${s3 ? `${a2}${s3.base}${s3.t}` : r2}${i3 ? "return " : ""}`}`, t2 ? `${n4 ? ";" : ""}${s3 ? `${a2}${s3.base}` : ""}` : `${o2}${s3 ? `${a2}${s3.base}` : r2}}`], d2 = n3 ? (e4) => ta.test(e4) : (e4) => !we.has(e4) && ta.test(e4);
            return { _: r2, cnst: l2, getDirectReturnFunction: u2, getDirectReturnIifeLeft: (e4, i3, { needsArrowReturnParens: s3, needsWrappedFunction: n4 }) => {
              ...
              }).join(",")}${0 === e4.length ? "" : t3 ? `${a2}${t3.base}` : r2}}`;
    ...
    za = { ecmaVersion: null, sourceType: "script", onInsertedSemicolon: null, onTrailingComma: null, allowReserved: null, allowReturnOutsideFunction: false, allowImportExportEverywhere: false, allowAwaitOutsideFunction: null, allowSuperOutsideMethod: null, allowHashBang: false, locations: false, onToken: null, onComment: null, ranges: false, program: null, sourceFile: null, directSourceFile: null, preserveParens: false };
    ja = false;
    Ha = function(e, t, i) {
      this.options = e = Ua(e), this.sourceFile = e.sourceFile, this.keywords = Ma(ca[e.ecmaVersion >= 6 ? 6 : "module" === e.sourceType ? "5module" : 5]);
      var s = "";
      true !== e.allowReserved && (s = la[e.ecmaVersion >= 6 ? 6 : 5 === e.ecmaVersion ? 5 : 3], "module" === e.sourceType && (s += " await")), this.reservedWords = Ma(s);
    ...
    Ya.isLet = function(e) {
      ...
      return !(Ia.test(this.input.slice(this.pos, i)) || "function" !== this.input.slice(i, i + 8) || i + 8 !== this.input.length && (ga(e = this.input.charCodeAt(i + 8)) || e > 55295 && e < 56320));
      ...
      switch (this.isLet(e) && (n2 = Aa._var, s = "let"), n2) {
        ...
        default:
          ...
          return n2 === Aa.name && "Identifier" === c2.type && this.eat(Aa.colon) ? this.parseLabeledStatement(r2, h2, c2, e) : this.parseExpressionStatement(r2, c2);
      }
    ...
    Ya.parseTryStatement = function(e) {
      ...
      for (void 0 === e && (e = true), void 0 === t && (t = this.startNode()), t.body = [], this.expect(Aa.braceL), e && this.enterScope(0); this.type !== Aa.braceR; ) {
    ...
    Ya.parseFunction = function(e, t, i, s, n2) {
      ...
      for (n2.body = [], this.expect(Aa.braceL); this.type !== Aa.braceR; ) {
        ...
        a2 && (n2.body.push(a2), "MethodDefinition" === a2.type && "constructor" === a2.kind ? (r2 && this.raise(a2.start, "Duplicate constructor in the same class"), r2 = true) : a2.key && "PrivateIdentifier" === a2.key.type && io(s, a2) && this.raiseRecoverable(a2.key.start, "Identifier '#" + a2.key.name + "' has already been declared"));
      }
      ...
      if (s ? (i.computed = false, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === Aa.parenL || "method" !== a2 || n2 || r2) {
      ...
      this.type === Aa.privateId ? ("constructor" === this.value && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = false, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e);
    }, Ya.parseClassMethod = function(e, t, i, s) {
      var n2 = e.key;
      "constructor" === e.kind ? (t && this.raise(n2.start, "Constructor can't be a generator"), i && this.raise(n2.start, "Constructor can't be an async method")) : e.static && so(e, "prototype") && this.raise(n2.start, "Classes may not have a static property named prototype");
      ...
      this.type === Aa.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, false)) : (true === t && this.unexpected(), e.id = null);
      ...
      e && ("string" != typeof t && (t = "Identifier" === t.type ? t.name : t.value), Oa(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = true);
    ...
    no.toAssignable = function(e, t, i) {
      ...
      return this.next(), 6 === this.options.ecmaVersion && this.type !== Aa.name && this.unexpected(), e.argument = this.parseBindingAtom(), this.finishNode(e, "RestElement");
      ...
      switch (e.type) {
        case "Identifier":
          this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (2 === t && "let" === e.name && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (Oa(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = true), 5 !== t && this.declareName(e.name, t, e.start));
          break;
        case "ChainExpression":
          this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
          break;
    ...
    }), f_stat: new ro("function", false), f_expr: new ro("function", true), f_expr_gen: new ro("function", true, false, null, true), f_gen: new ro("function", false, false, null, true) };
    oo = Ha.prototype;
    oo.initialContext = function() {
      ...
      if (1 !== this.context.length) {
        ...
        e === ao.b_stat && "function" === this.curContext().token && (e = this.context.pop()), this.exprAllowed = !e.isExpr;
      } else
      ...
      var t = false;
      this.options.ecmaVersion >= 6 && e !== Aa.dot && ("of" === this.value && !this.exprAllowed || "yield" === this.value && this.inGeneratorContext()) && (t = true), this.exprAllowed = t;
    };
    lo = Ha.prototype;
    lo.checkPropClash = function(e, t, i) {
      ...
      this.type !== Aa.parenL && this.type !== Aa.name || (this.potentialArrowAt = this.start, this.potentialArrowInForAwait = "await" === e);
      var h2 = this.parseMaybeConditional(e, t);
      if (i && (h2 = i.call(this, h2, o2, l2)), this.type.isAssign) {
        var c2 = this.startNodeAt(o2, l2);
        return c2.operator = this.value, this.type === Aa.eq && (h2 = this.toAssignable(h2, false, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= h2.start && (t.shorthandAssign = -1), this.type === Aa.eq ? this.checkLValPattern(h2) : this.checkLValSimple(h2), c2.left = h2, this.next(), c2.right = this.parseMaybeAssign(e), a2 > -1 && (t.doubleProto = a2), this.finishNode(c2, "AssignmentExpression");
      }
      ...
      if (null != r2 && (!n2 || this.type !== Aa._in) && r2 > s) {
      ...
      if (this.isContextual("await") && this.canAwait)
        ...
        o2.operator = this.value, o2.prefix = true, this.next(), o2.argument = this.parseMaybeUnary(null, true, l2, s), this.checkExpressionErrors(e, true), l2 ? this.checkLValSimple(o2.argument) : this.strict && "delete" === o2.operator && "Identifier" === o2.argument.type ? this.raiseRecoverable(o2.start, "Deleting local variable in strict mode") : "delete" === o2.operator && ho(o2.argument) ? this.raiseRecoverable(o2.start, "Private fields can not be deleted") : t = true, n2 = this.finishNode(o2, l2 ? "UpdateExpression" : "UnaryExpression");
        ...
        (s || 0 === this.privateNameStack.length) && this.unexpected(), n2 = this.parsePrivateIdent(), this.type !== Aa._in && this.unexpected();
    ...
    }, lo.parseSubscript = function(e, t, i, s, n2, r2, a2) {
      ...
      if (h2 || l2 && this.type !== Aa.parenL && this.type !== Aa.backQuote || this.eat(Aa.dot)) {
        ...
        c2.object = e, h2 ? (c2.property = this.parseExpression(), this.expect(Aa.bracketR)) : this.type === Aa.privateId && "Super" !== e.type ? c2.property = this.parsePrivateIdent() : c2.property = this.parseIdent("never" !== this.options.allowReserved), c2.computed = !!h2, o2 && (c2.optional = l2), e = this.finishNode(c2, "MemberExpression");
      ...
      switch (this.type) {
        ...
        case Aa.name:
          ...
          if (this.options.ecmaVersion >= 8 && !a2 && "async" === o2.name && !this.canInsertSemicolon() && this.eat(Aa._function))
          ...
          if (s && !this.canInsertSemicolon()) {
            ...
            if (this.options.ecmaVersion >= 8 && "async" === o2.name && this.type === Aa.name && !a2 && (!this.potentialArrowInForAwait || "of" !== this.value || this.containsEsc))
      ...
      if (this.options.ecmaVersion >= 6) {
        this.next();
        var a2, o2 = this.start, l2 = this.startLoc, h2 = [], c2 = true, u2 = false, d2 = new Xa(), p2 = this.yieldPos, f2 = this.awaitPos;
    ...
    lo.parseNew = function() {
      ...
      return e.callee = this.parseSubscripts(this.parseExprAtom(), s, n2, true, false), r2 && "ImportExpression" === e.callee.type && this.raise(s, "Cannot use new with import()"), this.eat(Aa.parenL) ? e.arguments = this.parseExprList(Aa.parenR, this.options.ecmaVersion >= 8, false) : e.arguments = co, this.finishNode(e, "NewExpression");
      ...
      return !e.computed && "Identifier" === e.key.type && "async" === e.key.name && (this.type === Aa.name || this.type === Aa.num || this.type === Aa.string || this.type === Aa.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === Aa.star) && !Ia.test(this.input.slice(this.lastTokEnd, this.start));
      ...
      this.options.ecmaVersion >= 6 && (a2.method = false, a2.shorthand = false, (e || t) && (n2 = this.start, r2 = this.startLoc), e || (i = this.eat(Aa.star)));
      var o2 = this.containsEsc;
      return this.parsePropertyName(a2), !e && !o2 && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(a2) ? (s = true, i = this.options.ecmaVersion >= 9 && this.eat(Aa.star), this.parsePropertyName(a2, t)) : s = false, this.parsePropertyValue(a2, e, i, s, n2, r2, t, o2), this.finishNode(a2, "Property");
    }, lo.parsePropertyValue = function(e, t, i, s, n2, r2, a2, o2) {
      ...
      else if (t || o2 || !(this.options.ecmaVersion >= 5) || e.computed || "Identifier" !== e.key.type || "get" !== e.key.name && "set" !== e.key.name || this.type === Aa.comma || this.type === Aa.braceR || this.type === Aa.eq)
        this.options.ecmaVersion >= 6 && !e.computed && "Identifier" === e.key.type ? ((i || s) && this.unexpected(), this.checkUnreserved(e.key), "await" !== e.key.name || this.awaitIdentPos || (this.awaitIdentPos = n2), e.kind = "init", t ? e.value = this.parseMaybeDefault(n2, r2, this.copyNode(e.key)) : this.type === Aa.eq && a2 ? (a2.shorthandAssign < 0 && (a2.shorthandAssign = this.start), e.value = this.parseMaybeDefault(n2, r2, this.copyNode(e.key))) : e.value = this.copyNode(e.key), e.shorthand = true) : this.unexpected();
      else {
      ...
      return e.key = this.type === Aa.num || this.type === Aa.string ? this.parseExprAtom() : this.parseIdent("never" !== this.options.allowReserved);
      ...
      var i = this.startNode();
      return this.type === Aa.name ? i.name = this.value : this.type.keyword ? (i.name = this.type.keyword, "class" !== i.name && "function" !== i.name || this.lastTokEnd === this.lastTokStart + 1 && 46 === this.input.charCodeAt(this.lastTokStart) || this.context.pop()) : this.unexpected(), this.next(!!e), this.finishNode(i, "Identifier"), e || (this.checkUnreserved(i), "await" !== i.name || this.awaitIdentPos || (this.awaitIdentPos = i.start)), i;
    }, lo.parsePrivateIdent = function() {
      var e = this.startNode();
      return this.type === Aa.privateId ? e.name = this.value : this.unexpected(), this.next(), this.finishNode(e, "PrivateIdentifier"), 0 === this.privateNameStack.length ? this.raise(e.start, "Private field '#" + e.name + "' must be declared in an enclosing class") : this.privateNameStack[this.privateNameStack.length - 1].used.push(e), e;
    ...
    Oo.prototype.reset = function(e, t, i) {
      ...
      for (var t = e.pos, i = 0; -1 !== (i = e.current()) && !Ro(i); )
        e.advance();
      return e.pos !== t;
      ...
      return 48 === e.current() && !Vo(e.lookahead()) && (e.lastIntValue = 0, e.advance(), true);
      ...
      if (e.eat(92)) {
        ...
        if (e.switchU) {
          var i = e.current();
          (99 === i || zo(i)) && e.raise("Invalid class escape"), e.raise("Invalid escape");
        }
        e.pos = t;
      }
      var s = e.current();
      ...
      var t = e.current();
      return !(!Vo(t) && 95 !== t) && (e.lastIntValue = t % 32, e.advance(), true);
    ...
    Uo.next = function(e) {
    ...
    }, "undefined" != typeof Symbol && (Uo[Symbol.iterator] = function() {
      var e = this;
      ...
      return ma(e, this.options.ecmaVersion >= 6) || 92 === e ? this.readWord() : this.getTokenFromCode(e);
      ...
      for (var t = this.pos, i = this.options.onComment && this.curPosition(), s = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !ka(s); )
      ...
      return this.options.ecmaVersion >= 6 && 46 === e && 46 === t ? (this.pos += 3, this.finishToken(Aa.ellipsis)) : (++this.pos, this.finishToken(Aa.dot));
    }, Uo.readToken_slash = function() {
      var e = this.input.charCodeAt(this.pos + 1);
      return this.exprAllowed ? (++this.pos, this.readRegexp()) : 61 === e ? this.finishOp(Aa.assign, 2) : this.finishOp(Aa.slash, 1);
    }, Uo.readToken_mult_modulo_exp = function(e) {
      var t = this.input.charCodeAt(this.pos + 1), i = 1, s = 42 === e ? Aa.star : Aa.modulo;
      return this.options.ecmaVersion >= 7 && 42 === e && 42 === t && (++i, s = Aa.starstar, t = this.input.charCodeAt(this.pos + 2)), 61 === t ? this.finishOp(Aa.assign, i + 1) : this.finishOp(s, i);
      ...
      if (t === e) {
        ...
        return this.finishOp(124 === e ? Aa.logicalOR : Aa.logicalAND, 2);
      }
      return 61 === t ? this.finishOp(Aa.assign, 2) : this.finishOp(124 === e ? Aa.bitwiseOR : Aa.bitwiseAND, 1);
    }, Uo.readToken_caret = function() {
      return 61 === this.input.charCodeAt(this.pos + 1) ? this.finishOp(Aa.assign, 2) : this.finishOp(Aa.bitwiseXOR, 1);
    }, Uo.readToken_plus_min = function(e) {
      var t = this.input.charCodeAt(this.pos + 1);
      return t === e ? 45 !== t || this.inModule || 62 !== this.input.charCodeAt(this.pos + 2) || 0 !== this.lastTokEnd && !Ia.test(this.input.slice(this.lastTokEnd, this.pos)) ? this.finishOp(Aa.incDec, 2) : (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : 61 === t ? this.finishOp(Aa.assign, 2) : this.finishOp(Aa.plusMin, 1);
    }, Uo.readToken_lt_gt = function(e) {
      var t = this.input.charCodeAt(this.pos + 1), i = 1;
      return t === e ? (i = 62 === e && 62 === this.input.charCodeAt(this.pos + 2) ? 3 : 2, 61 === this.input.charCodeAt(this.pos + i) ? this.finishOp(Aa.assign, i + 1) : this.finishOp(Aa.bitShift, i)) : 33 !== t || 60 !== e || this.inModule || 45 !== this.input.charCodeAt(this.pos + 2) || 45 !== this.input.charCodeAt(this.pos + 3) ? (61 === t && (i = 2), this.finishOp(Aa.relational, i)) : (this.skipLineComment(4), this.skipSpace(), this.nextToken());
    }, Uo.readToken_eq_excl = function(e) {
      var t = this.input.charCodeAt(this.pos + 1);
      return 61 === t ? this.finishOp(Aa.equality, 61 === this.input.charCodeAt(this.pos + 2) ? 3 : 2) : 61 === e && 62 === t && this.options.ecmaVersion >= 6 ? (this.pos += 2, this.finishToken(Aa.arrow)) : this.finishOp(61 === e ? Aa.eq : Aa.prefix, 1);
      ...
      var e = 35;
      if (this.options.ecmaVersion >= 13 && (++this.pos, ma(e = this.fullCharCodeAtPos(), true) || 92 === e))
      ...
      return null == i && this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && 110 === this.input.charCodeAt(this.pos) ? (i = Go(this.input.slice(t, this.pos)), ++this.pos) : ma(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(Aa.num, i);
      ...
      i && /[89]/.test(this.input.slice(t, this.pos)) && (i = false), 46 !== s || i || (++this.pos, this.readInt(10), s = this.input.charCodeAt(this.pos)), 69 !== s && 101 !== s || i || (43 !== (s = this.input.charCodeAt(++this.pos)) && 45 !== s || ++this.pos, null === this.readInt(10) && this.raise(t, "Invalid number")), ma(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
    ...
    Uo.tryReadTemplateToken = function() {
      ...
      for (var e = "", t = this.pos; ; ) {
        ...
        if (96 === i || 36 === i && 123 === this.input.charCodeAt(this.pos + 1))
          return this.pos !== this.start || this.type !== Aa.template && this.type !== Aa.invalidTemplate ? (e += this.input.slice(t, this.pos), this.finishToken(Aa.template, e)) : 36 === i ? (this.pos += 2, this.finishToken(Aa.dollarBraceL)) : (++this.pos, this.finishToken(Aa.backQuote));
        if (92 === i)
      ...
      for (var e = "", t = true, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
        ...
        if (ga(n2, s))
          ...
          (t ? ma : ga)(a2, s) || this.invalidStringToken(r2, "Invalid Unicode escape"), e += Da(a2), i = this.pos;
        }
        t = false;
      }
    ...
    Ha.acorn = { Parser: Ha, version: "8.7.1", defaultOptions: za, Position: Va, SourceLocation: Ba, getLineInfo: Fa, Node: mo, TokenType: ya, tokTypes: Aa, keywordTypes: va, TokContext: ro, tokContexts: ao, isIdentifierChar: ga, isIdentifierStart: ma, Token: jo, isNewLine: ka, lineBreak: Ia, lineBreakG: Pa, nonASCIIwhitespace: Ca };
    Wo = (e) => () => {
    ...
    qo = { mkdir: Wo("fs.mkdir"), readFile: Wo("fs.readFile"), writeFile: Wo("fs.writeFile") };
    Yo = [{ active: true, deprecated: "resolveAssetUrl", replacement: "resolveFileUrl" }];
    Qo = { delete: () => false, get() {
    }, has: () => false, set() {
    } };
    el = class {
      ...
      async addEntryModules(e, t) {
        ...
        const n2 = await this.extendLoadModulesPromise(Promise.all(e.map(({ id: e2, importer: t2 }) => this.loadEntryModule(e2, true, t2, null))).then((n3) => {
          for (let r2 = 0; r2 < n3.length; r2++) {
            const a2 = n3[r2];
            a2.isUserDefinedEntryPoint = a2.isUserDefinedEntryPoint || t, il(a2, e[r2], t, s + r2);
      ...
      addEntryWithImplicitDependants(e, t) {
        ...
        return this.extendLoadModulesPromise(this.loadEntryModule(e.id, false, e.importer, null).then(async (s) => {
          if (il(s, e, false, i), !s.info.isEntry) {
      ...
      async addModuleSource(e, t, i) {
        ...
        try {
          s = await this.graph.fileOperationQueue.run(async () => {
            var t2;
            return null !== (t2 = await this.pluginDriver.hookFirst("load", [e])) && void 0 !== t2 ? t2 : await qo.readFile(e, "utf8");
          });
        } catch (i2) {
          tn("load modules", 3);
        ...
        if (!r2 || r2.customTransformCache || r2.originalCode !== n2.code || await this.pluginDriver.hookFirst("shouldTransformCachedModule", [{ ast: r2.ast, code: r2.code, id: r2.id, meta: r2.meta, moduleSideEffects: r2.moduleSideEffects, resolvedSources: r2.resolvedIds, syntheticNamedExports: r2.syntheticNamedExports }]))
          i.updateOptions(n2), i.setSource(await Jo(n2, i, this.pluginDriver, this.options.onwarn));
        else {
      ...
      async fetchModule({ id: e, meta: t, moduleSideEffects: i, syntheticNamedExports: s }, n2, r2, a2) {
        ...
        const h2 = this.addModuleSource(e, n2, l2).then(() => [this.getResolveStaticDependencyPromises(l2), this.getResolveDynamicImportPromises(l2), c2]), c2 = nl(h2).then(() => this.pluginDriver.hookParallel("moduleParsed", [l2.info]));
        c2.catch(() => {
      ...
      getNormalizedResolvedIdWithoutDefaults(e, t, i) {
        ...
        if (e) {
          if ("object" == typeof e) {
            ...
            return { ...e, external: n4 && ("relative" === n4 || !k(e.id) || true === n4 && sl(e.id, i, s) || "absolute") };
          }
          const n3 = this.options.external(e, t, true);
          return { external: n3 && (sl(e, i, s) || "absolute"), id: n3 && s ? tl(e, t) : e };
        }
        const n2 = s ? tl(i, t) : i;
        return false === e || this.options.external(n2, t, true) ? { external: sl(n2, i, s) || "absolute", id: n2 } : null;
      }
      ...
      async handleExistingModule(e, t, i) {
        ...
        if (i)
          return "resolveDependencies" === i ? nl(s) : s;
        if (t) {
      ...
      async loadEntryModule(e, t, i, s) {
        const n2 = await Ko(e, i, this.options.preserveSymlinks, this.pluginDriver, this.resolveId, null, se, true);
    ...
    ll = Object.keys({ buildEnd: 1, buildStart: 1, closeBundle: 1, closeWatcher: 1, load: 1, moduleParsed: 1, options: 1, resolveDynamicImport: 1, resolveId: 1, shouldTransformCachedModule: 1, transform: 1, watchChange: 1 });
    hl = class {
      constructor(e, t, i, s, n2) {
        this.graph = e, this.options = t, this.pluginCache = s, this.sortedPlugins = /* @__PURE__ */ new Map(), this.unfulfilledActions = /* @__PURE__ */ new Set(), function(e2, t2) {
          for (const { active: i2, deprecated: s2, replacement: n3 } of Yo)
            for (const r3 of e2)
        ...
        const r2 = /* @__PURE__ */ new Set();
        if (this.pluginContexts = new Map(this.plugins.map((i2) => [i2, ol(i2, s, e, t, this.fileEmitter, r2)])), n2)
          for (const e2 of i)
            for (const i2 of ll)
      ...
      createOutputPluginDriver(e) {
        return new hl(this.graph, this.options, e, this.pluginCache, this);
      }
      ...
      async hookReduceValue(e, t, i, s) {
        const n2 = [], r2 = [];
        for (const t2 of this.getSortedPlugins(e, dl))
      ...
      getSortedPlugins(e, t) {
        return R(this.sortedPlugins, e, () => cl(e, this.plugins, t));
      }
      runHook(e, t, i, s) {
        ...
        }).catch((t2) => (null !== o2 && this.unfulfilledActions.delete(o2), Xo(t2, i.name, { hook: e })));
      }
      runHookSync(e, t, i, s) {
        const n2 = i[e], r2 = "object" == typeof n2 ? n2.handler : n2;
        let a2 = this.pluginContexts.get(i);
    ...
    ml = class {
      constructor(e, t) {
        var i, s;
        if (this.options = e, this.cachedModules = /* @__PURE__ */ new Map(), this.deoptimizationTracker = new U(), this.entryModules = [], this.modulesById = /* @__PURE__ */ new Map(), this.needsTreeshakingPass = false, this.phase = Gs.LOAD_AND_PARSE, this.scope = new rl(), this.watchFiles = /* @__PURE__ */ Object.create(null), this.watchMode = false, this.externalModules = [], this.implicitEntryModules = [], this.modules = [], this.getModuleInfo = (e2) => {
        ...
        this.pluginDriver = new hl(this, e, e.plugins, this.pluginCache), this.acornParser = Ha.extend(...e.acornInjectPlugins), this.moduleLoader = new el(this, this.modulesById, this.options, this.pluginDriver), this.fileOperationQueue = new fl(e.maxParallelFileOps);
      }
      async build() {
    ...
    Sl = (e, t, i, s) => {
      ...
      if (n2) {
        ...
        if (s2)
          return { ...s2, ...e };
        pe(xe(`${i}.preset`, Al(i), `valid values are ${oe(Object.keys(t))}`, n2));
      }
      return ((e2, t2, i2) => (s2) => {
        if ("string" == typeof s2) {
          const n3 = e2[s2];
          if (n3)
            return n3;
          pe(xe(t2, Al(t2), `valid values are ${i2}${oe(Object.keys(e2))}. You can also supply an object for more fine-grained control`, s2));
        }
        return ((e3) => e3 && "object" == typeof e3 ? e3 : {})(s2);
      })(t, i, s)(e);
    };
    Al = (e) => e.split(".").join("").toLowerCase();
    Il = (e) => {
      const { onwarn: t } = e;
      return t ? (e2) => {
        e2.toString = () => {
    ...
    Pl = (e) => ({ allowAwaitOutsideFunction: true, ecmaVersion: "latest", preserveParens: false, sourceType: "module", ...e.acorn });
    kl = (e) => gl(e.acornInjectPlugins);
    wl = (e) => {
      var t;
    ...
    Dl = (e, t, i) => {
      ...
      if (false === s)
        return false;
      const n2 = Sl(e.treeshake, bl, "treeshake", "false, true, ");
      return void 0 !== n2.pureExternalModules && ke(`The "treeshake.pureExternalModules" option is deprecated. The "treeshake.moduleSideEffects" option should be used instead. "treeshake.pureExternalModules: true" is equivalent to "treeshake.moduleSideEffects: 'no-external'"`, true, t, i), { annotations: false !== n2.annotations, correctVarValueBeforeDeclaration: true === n2.correctVarValueBeforeDeclaration, moduleSideEffects: "object" == typeof s && s.pureExternalModules ? Ll(s.moduleSideEffects, s.pureExternalModules) : Ll(n2.moduleSideEffects, void 0), propertyReadSideEffects: "always" === n2.propertyReadSideEffects ? "always" : false !== n2.propertyReadSideEffects, tryCatchDeoptimization: false !== n2.tryCatchDeoptimization, unknownGlobalSideEffects: false !== n2.unknownGlobalSideEffects };
    };
    Ll = (e, t) => {
      if ("boolean" == typeof e)
        return () => e;
    ...
    ql = (e) => {
      const t = { autoId: false, basePath: "", define: "define", ...e.amd };
    ...
    Jl = (e, t) => {
      const i = Sl(e.generatedCode, vl, "output.generatedCode", "");
    ...
    th = /* @__PURE__ */ new Set(["auto", "esModule", "default", "defaultOnly", true, false]);
    ih = (e, t) => {
      const i = e.interop, s = /* @__PURE__ */ new Set(), n2 = (e2) => {
        if (!s.has(e2)) {
          if (s.add(e2), !th.has(e2))
            return pe(xe("output.interop", "outputinterop", `use one of ${Array.from(th, (e3) => JSON.stringify(e3)).join(", ")}`, e2));
...
*/
//# sourceMappingURL=chunk-VQC7UW6D.js.map
